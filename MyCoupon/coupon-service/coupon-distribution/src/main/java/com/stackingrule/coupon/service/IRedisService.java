...
public interface IRedisService {
    ...
    /**
     * <h2>根据 userId 和状态找到缓存的优惠券列表数据,没有加一个-1</h2>
     * @param userId 用户 id
    ...
    /**
     * <h2>尝试从 coupon_template_code 中获取一个优惠券码</h2>
    ...
    /**
     * <h2>将优惠券保存到 Cache 中，无业务逻辑</h2>
     * @param userId 用户 id
     * @param coupons {@link Coupon}s
     * @param status 优惠券状态
     * @return 保存成功的个数
     */
    Integer addCouponToCacheFromDb(Long userId,
                             List<Coupon> coupons,
                             Integer status) throws CouponException;
